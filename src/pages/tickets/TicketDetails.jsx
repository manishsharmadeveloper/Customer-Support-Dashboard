        ...
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-3 shadow-sm">
            ...
            <select
              ...
              className="min-w-45 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
            >
